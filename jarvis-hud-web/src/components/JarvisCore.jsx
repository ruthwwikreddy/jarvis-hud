...
export default function JarvisCore({ audioLevel, config }) {
    return (
        <motion.div
        ...
        >
            <div className="canvas-container">
                <Canvas camera={{ position: [0, 0, 8], fov: 50 }}>
                    ...
                    <JarvisOrb audioLevel={audioLevel} />
                </Canvas>
            </div>
            ...
            <div className="jarvis-ui">
                ...
                <div className="jarvis-core-status">
                    ...
                    <span className="status-value pulse">ONLINE</span>
                </div>
            </div>
        </motion.div>
    )
